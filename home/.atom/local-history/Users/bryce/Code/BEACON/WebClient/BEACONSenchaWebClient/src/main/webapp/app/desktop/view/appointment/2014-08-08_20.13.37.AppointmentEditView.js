...
Ext.define('Beacon.view.appointment.AppointmentEditView', {
    ...
    applyTheAppointment: function(theAppointment){
        ...
        var scheduledStartDate = theAppointment.data.scheduledStart;
        var scheduledEndDate = theAppointment.data.scheduledEnd;

        this.scheduledStartDate = scheduledStartDate;
        this.scheduledEndDate = scheduledEndDate;

        var scheduledStartTime = theAppointment.data.scheduledStart;
        var scheduledEndTime = theAppointment.data.scheduledEnd;
