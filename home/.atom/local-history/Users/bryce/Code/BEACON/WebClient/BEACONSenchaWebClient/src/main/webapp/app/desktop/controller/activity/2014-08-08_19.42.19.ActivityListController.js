	...
	onCreateActivityFromCase: function(caseId) {
		...
		Deft.Promise.all([
			...
			success: function(results) {
				...
				me.showPracticeActivities(practiceView, sapId);

				var newCase = CaseFactoryManager.createActivityFromCase(practiceModel, theCase);

				var actController = me.getController('activity.ActivityFormController');
				actController.editActivity(practiceView, newCase, sapId, false, sapId);
